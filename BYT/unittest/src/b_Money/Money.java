...
public class Money implements Comparable {
	...
	public String toString() {
		return String.format("%.1f %s", amount / 100.0, currency.getName());
	}
	...
	public Money add(Money other) {
		int other_amount = currency.valueInThisCurrency(other.getAmount(), other.currency);
		return new Money(amount + other_amount, currency);
	}
	...
	public int compareTo(Object other) {
		...
		int universal = universalValue();
		int other_universal = money.universalValue();
		
		return other_universal - universal;
	}
}